<ul class="board_list">
    ...
    $sql = "select * from $table order by check_fix desc, regist_day desc, num desc";    // 일련번호 내림차순 검색
    ...
    for ($i = $start; $i < $start + $scale && $i < $total_record; $i++) {
        ...
        <li>
            ...
            <span class="col6"><?= $count_saw ?></span>
...
<ul class="buttons">
    ...
    ?>
    <li>
        <button onclick="location.href='<?= $list_url ?>'">목록</button>
    </li>
    <?php
    if ($userid) {
